 ...
 * 02110-1301, USA.
 */
#ifndef SWIRLY_ASH_INTWRAPPER_HPP
#define SWIRLY_ASH_INTWRAPPER_HPP
...
struct SWIRLY_PACKED IntWrapper : IntBase {
  ...
  constexpr explicit IntWrapper(RhsT rhs) noexcept : value_{static_cast<ValueType>(rhs)}
  {
  }
...
#endif // SWIRLY_ASH_INTWRAPPER_HPP
