...
FIND_LIBRARY(SWIRLY_WS_LIBRARY NAMES swirly_ws
             HINTS "$ENV{SWIRLY_HOME}/lib")
FIND_LIBRARY(SWIRLY_OM_LIBRARY NAMES swirly_om
             HINTS "$ENV{SWIRLY_HOME}/lib")
...
MARK_AS_ADVANCED(SWIRLY_INCLUDE_DIR SWIRLY_UNIT_LIBRARY SWIRLY_WS_LIBRARY SWIRLY_OM_LIBRARY SWIRLY_FIN_LIBRARY SWIRLY_UTIL_LIBRARY)

# Copy the results to the output variables.
IF(SWIRLY_FOUND)
  SET(SWIRLY_INCLUDE_DIRS ${SWIRLY_INCLUDE_DIR})
  SET(SWIRLY_LIBRARIES ${SWIRLY_WS_LIBRARY} ${SWIRLY_OM_LIBRARY} ${SWIRLY_FIN_LIBRARY} ${SWIRLY_UTIL_LIBRARY})
ENDIF()
