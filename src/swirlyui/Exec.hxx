...
class Exec {
  public:
    Exec(const QDateTime& created, const QString& accnt, const Market& market, Id64 id,
    ...
    static Exec from_json(const Market& market, const QJsonObject& obj);

    ExecKey key() const noexcept { return {market_.id(), id_}; }
