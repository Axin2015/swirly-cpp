...
void TestModel::do_read_product(const ModelCallback<ProductPtr>& cb) const
{
    // Forex.
    cb(Product::make(1_id32, "EURUSD"sv, "EURUSD"sv, "EUR"sv, "USD"sv, 1000000, 1, 1, 10000, 4,
                     1_lts, 10_lts));
    cb(Product::make(2_id32, "GBPUSD"sv, "GBPUSD"sv, "GBP"sv, "USD"sv, 1000000, 1, 1, 10000, 4,
                     1_lts, 10_lts));
    cb(Product::make(3_id32, "USDCHF"sv, "USDCHF"sv, "USD"sv, "CHF"sv, 1000000, 1, 1, 10000, 4,
                     1_lts, 10_lts));
    cb(Product::make(4_id32, "USDJPY"sv, "USDJPY"sv, "USD"sv, "JPY"sv, 1000000, 1, 1, 100, 2, 1_lts,
                     10_lts));
    // Coal.
    cb(Product::make(5_id32, "CAP"sv, "Central Appalachia Coal"sv, "CAP"sv, "USD"sv, 1000, 1, 1, 20,
                     2, 1_lts, 10_lts));
    cb(Product::make(6_id32, "NAP"sv, "Northern Appalachia Coal"sv, "NAP"sv, "USD"sv, 1000, 1, 1,
                     20, 2, 1_lts, 10_lts));
    cb(Product::make(7_id32, "ILB"sv, "Illinois Basin Coal"sv, "ILB"sv, "USD"sv, 1000, 1, 1, 20, 2,
                     1_lts, 10_lts));
    cb(Product::make(8_id32, "PRB"sv, "Powder River Basin Coal"sv, "PRB"sv, "USD"sv, 1000, 1, 1, 20,
                     2, 1_lts, 10_lts));
    cb(Product::make(9_id32, "UIB"sv, "Uinta Basin Coal"sv, "UIB"sv, "USD"sv, 1000, 1, 1, 20, 2,
                     1_lts, 10_lts));
    // Coffee.
    cb(Product::make(10_id32, "WYCA"sv, "Yirgachefe A"sv, "WYCA"sv, "ETB"sv, 1, 1, 1, 1, 0, 1_lts,
                     10_lts));
    cb(Product::make(11_id32, "WWNA"sv, "Wenago A"sv, "WWNA"sv, "ETB"sv, 1, 1, 1, 1, 0, 1_lts,
                     10_lts));
    cb(Product::make(12_id32, "WKCA"sv, "Kochere A"sv, "WKCA"sv, "ETB"sv, 1, 1, 1, 1, 0, 1_lts,
                     10_lts));
    cb(Product::make(13_id32, "WGAA"sv, "Gelena Abaya A"sv, "WGAA"sv, "ETB"sv, 1, 1, 1, 1, 0, 1_lts,
                     10_lts));
    // US Corporates.
    cb(Product::make(14_id32, "CSCO"sv, "Cisco Systems Inc"sv, "CSCO"sv, "USD"sv, 1, 1, 1, 1000, 3,
                     1_lts, 10_lts));
    cb(Product::make(15_id32, "DIS"sv, "Walt Disney"sv, "DIS"sv, "USD"sv, 1, 1, 1, 1000, 3, 1_lts,
                     10_lts));
    cb(Product::make(16_id32, "IBM"sv, "Ibm Corp"sv, "IBM"sv, "USD"sv, 1, 1, 1, 1000, 3, 1_lts,
                     10_lts));
    cb(Product::make(17_id32, "INTC"sv, "Intel Corp"sv, "INTC"sv, "USD"sv, 1, 1, 1, 1000, 3, 1_lts,
                     10_lts));
    cb(Product::make(18_id32, "MSFT"sv, "Microsoft Corp"sv, "MSFT"sv, "USD"sv, 1, 1, 1, 1000, 3,
                     1_lts, 10_lts));
    cb(Product::make(19_id32, "VIA"sv, "Viacom Inc"sv, "VIA"sv, "USD"sv, 1, 1, 1, 1000, 3, 1_lts,
                     10_lts));
    cb(Product::make(20_id32, "VOD"sv, "Vodafone Group Plc"sv, "VOD"sv, "USD"sv, 1, 1, 1, 1000, 3,
                     1_lts, 10_lts));
    cb(Product::make(21_id32, "VZ"sv, "Verizon Com"sv, "VZ"sv, "USD"sv, 1, 1, 1, 1000, 3, 1_lts,
                     10_lts));
}
