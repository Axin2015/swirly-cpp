...
void Serv::archiveOrder(TraderSess& sess, string_view market, const IdenView& ids, Millis now)
{
}
...
void Serv::archiveTrade(TraderSess& sess, string_view market, const IdenView& ids, Millis now)
{
}
