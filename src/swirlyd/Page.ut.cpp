...
{
    auto page = parse_query("offset=1"sv);
...
{
    auto page = parse_query("limit=2"sv);
    BOOST_TEST(page.offset == 0U);
    BOOST_TEST(!!page.limit);
...
{
    auto page = parse_query("offset=1&limit=2"sv);
    BOOST_TEST(page.offset == 1U);
    BOOST_TEST(!!page.limit);
    BOOST_TEST(*page.limit == 2U);
}
...
{
    auto page = parse_query("limit=2&offset=1"sv);
    BOOST_TEST(page.offset == 1U);
    BOOST_TEST(!!page.limit);
    BOOST_TEST(*page.limit == 2U);
}
...
{
    auto page = parse_query("foo=1&bar=2"sv);
    BOOST_TEST(page.offset == 0U);
    BOOST_TEST(!page.limit);
}
