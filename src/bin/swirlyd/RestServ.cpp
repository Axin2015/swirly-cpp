...
void RestServ::orderRequest(HttpMessage data, Millis now)
{
  ...
  if (uri_.empty()) {
    ...
    case MethodGet:
      ...
      state_ |= MatchMethod;
      rest_.getOrder(getTrader(data), market, now, out_);
      break;
    case MethodPost:
      ...
      state_ |= MatchMethod;
      {
        ...
        rest_.postOrder(accnt, market, request_.ref(), request_.side(), request_.lots(),
  ...
  if (uri_.empty()) {
    ...
    case MethodGet:
      ...
      state_ |= MatchMethod;
      rest_.getOrder(getTrader(data), market, ids_[0], now, out_);
      break;
    case MethodPut:
      ...
      state_ |= MatchMethod;
      {
        ...
        rest_.putOrder(accnt, market, ids_, request_.lots(), now, out_);
      }
      break;
    }
    return;
...
void RestServ::tradeRequest(HttpMessage data, Millis now)
{
  ...
  if (uri_.empty()) {
    ...
    case MethodGet:
      ...
      state_ |= MatchMethod;
      rest_.getTrade(getTrader(data), market, now, out_);
      break;
    case MethodPost:
  ...
  if (uri_.empty()) {
    ...
    case MethodGet:
      ...
      state_ |= MatchMethod;
      rest_.getTrade(getTrader(data), market, ids_[0], now, out_);
      break;
    case MethodDelete:
      // DELETE /accnt/trade/MARKET/ID,ID...
      state_ |= MatchMethod;
      rest_.deleteTrade(getTrader(data), market, ids_, now);
      break;
    }
    return;
  }
