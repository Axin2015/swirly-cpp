...
{
    struct DbrSlNode* node = dbr_ctx_find_rec_id(ctx, type, id);
    check(node != NULL);
...
{
    struct DbrSlNode* node = dbr_ctx_find_rec_mnem(ctx, type, mnem);
    check(node != NULL);
    return dbr_rec_entry(node);
}
...
find_instr(void)
{
    ...
    struct DbrSlNode* node = dbr_ctx_find_rec_mnem(ctx, DBR_INSTR, "BAD");
    check(node == NULL);
...
find_market(void)
{
    ...
    struct DbrSlNode* node = dbr_ctx_find_rec_mnem(ctx, DBR_MARKET, "BAD");
    check(node == NULL);
...
find_accnt(void)
{
    ...
    struct DbrSlNode* node = dbr_ctx_find_rec_mnem(ctx, DBR_ACCNT, "BAD");
    check(node == NULL);
...
find_trader(void)
{
    ...
    struct DbrSlNode* node = dbr_ctx_find_rec_mnem(ctx, DBR_TRADER, "BAD");
    check(node == NULL);
