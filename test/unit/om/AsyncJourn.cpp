 ...
 * 02110-1301, USA.
 */
#include <swirly/om/AsyncJourn.hpp>
...
SWIRLY_FIXTURE_TEST_CASE(AsyncJournCreateExec, AsyncJournFixture)
{
  ...
  execs[0] = makeRefCounted<Exec>("MARAYL"_sv, MarketId, "EURUSD"_sv, SettlDay, 1_id64, 2_id64,
                                  "REF"_sv, State::New, Side::Buy, 10_lts, 12345_tks, 10_lts, 0_lts,
                                  0_cst, 0_lts, 0_tks, 1_lts, 0_id64, LiqInd::None, Mnem{}, Now);
  execs[1]
    = makeRefCounted<Exec>("MARAYL"_sv, MarketId, "EURUSD"_sv, SettlDay, 3_id64, 2_id64, "REF"_sv,
